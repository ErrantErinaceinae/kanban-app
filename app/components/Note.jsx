...
export default class Note extends React.Component {
    ...
    renderEdit = () => {
        ...
        return <input type="text" ref={element => element
    ...
    renderDelete = () => {
        return <button className="delete-note" onClick={this.props.onDelete}>Delete Note</button>;
    };

    delete = (event) => {
        if (this.props.onDelete) {
            this.props.onDelete(event.target.value.id);
        }
    }
    ...
    finishEdit = (event) => {
        ...
        //
        // See the *Typing event React* chapter for more information.
